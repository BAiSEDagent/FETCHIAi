...
const permitFieldMap: ArcGisStructuredSourceConfig<StructuredPermitRecord>['fieldMap'] = {
  permitNumber: ['PermitNumber', 'PERMIT_NUMBER'],
  issuedAt: ['DateIssued', 'ISSUED_DATE'],
  enteredAt: ['DateEntered', 'ENTERED_DATE'],
  calculatedAddress: ['CalculatedAddress', 'CALCULATED_ADDRESS'],
  freeFormAddress: ['FreeFormAddress', 'ADDRESS'],
  recordCategory: ['GeneralCategory', 'RECORD_CATEGORY'],
  typeOfWork: ['TypeofWork', 'TYPE_OF_WORK'],
  structureType: ['TypeofStructure', 'STRUCTURE_TYPE'],
  workDescription: ['WorkDescription', 'WORK_DESCRIPTION'],
  valuation: ['Valuation', 'VALUATION'],
  squareFootage: ['SquareFootage', 'SQUARE_FOOTAGE'],
  numberOfUnits: ['NumberofUnits', 'NUMBER_OF_UNITS'],
...
const albuquerquePermitOutFields = [
  'OBJECTID',
  'PermitNumber',
  'DateIssued',
  'DateEntered',
...
export const ALBUQUERQUE_BUILDING_PERMITS: ArcGisStructuredSourceConfig<StructuredPermitRecord> = {
  ...
  identityFields: {
    address: ['CalculatedAddress', 'FreeFormAddress'],
    name: ['Owner', 'Applicant', 'Contractor'],
    locality: ['CalculatedAddress'],
  },
  externalIdFields: ['OBJECTID', 'PermitNumber'],
  dateFields: ['DateIssued', 'DateEntered'],
  outFields: [...albuquerquePermitOutFields],
  orderByFields: ['DateIssued DESC', 'DateEntered DESC', 'OBJECTID DESC'],
...
export const FIXTURE_SECOND_ARCGIS_SOURCE: ArcGisStructuredSourceConfig<StructuredPermitRecord> = {
  ...
  orderByFields: ['issued_on DESC', 'entered_on DESC', 'fixture_object_id DESC'],
  fieldMap: {
