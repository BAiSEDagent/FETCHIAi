  ...
  return (
    <div className="flex flex-col h-[calc(100vh-3.5rem)] lg:h-screen bg-brand-parchment">
      <div className="px-5 lg:px-7 pt-6 lg:pt-7 pb-5">
        <h1 className="font-outfit text-h1 lg:text-[32px] text-brand-near-black">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <div className="text-[12.5px] text-brand-near-black/60 mt-0.5 flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-brand-green" aria-label="active" />
      ...
      >
        <div className="flex items-center gap-2">
          <button
            ...
            className="h-11 w-11 rounded-full bg-brand-cream-muted border border-brand-near-black/10 flex items-center justify-center text-brand-near-black/45 cursor-not-allowed flex-shrink-0"
            disabled
          >
          ...
          <div
            className={`flex-1 flex items-center bg-brand-cream-muted rounded-full border transition-colors ${
              hasInput
